...
#[ACL\Admin(enable: true, title: 'TipoProva', description: 'Permissões modulo TipoProva')]
class TipoProvaAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar TipoProva')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar TipoProva')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar TipoProva')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar TipoProva')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir TipoProva')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir TipoProva em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar TipoProva')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar TipoProva')]
