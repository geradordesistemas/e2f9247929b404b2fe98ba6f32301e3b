...
use App\Application\Schema\ProfessorBundle\Form\ProfessorType;
...
#[Route('/web/professor', name: 'web_professor_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Professor', description: 'Permissões do modulo Professor')]
class ProfessorWebController extends BaseWebController
{
    public function getBaseRouter(): string
    {
        return 'web_professor_';
    }
    ...
    {
        return "@ApplicationSchemaProfessor/professor/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Professor')]
    ...
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Professor')]
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Professor')]
    ...
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Professor')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Professor')]
