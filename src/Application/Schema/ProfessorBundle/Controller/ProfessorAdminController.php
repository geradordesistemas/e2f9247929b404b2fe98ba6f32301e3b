...
#[ACL\Admin(enable: true, title: 'Professor', description: 'Permissões modulo Professor')]
class ProfessorAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Professor')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Professor')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Professor')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Professor')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Professor')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Professor em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Professor')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Professor')]
