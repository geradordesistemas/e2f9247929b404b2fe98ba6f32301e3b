...
#[ACL\Admin(enable: true, title: 'Prova', description: 'Permissões modulo Prova')]
class ProvaAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Prova')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Prova')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Prova')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Prova')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Prova')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Prova em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Prova')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Prova')]
