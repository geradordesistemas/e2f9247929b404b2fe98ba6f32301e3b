...
#[ACL\Admin(enable: true, title: 'Disciplina', description: 'Permissões modulo Disciplina')]
class DisciplinaAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Disciplina')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Disciplina')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Disciplina')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Disciplina')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Disciplina')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Disciplina em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Disciplina')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Disciplina')]
